...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 16:52:08 2019
...
def main():
    ...
    dataset = handel_missing_values(dataset, dataset.columns[6], '?')
    train_x, test_x, train_y, test_y = split_dataset(dataset, 0.7, dataset.columns[1:-1], dataset.columns[-1])
